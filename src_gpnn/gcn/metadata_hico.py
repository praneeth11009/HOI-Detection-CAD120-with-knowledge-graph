...
# Not the hoi list object order as in list_action!!
...
# 117 classes, same order in hico_det_meta.h5
...
# 600 hoi classes based on 81 coco_classes order, including background, not groundtruth class order
...
obj_actions = [[action_classes.index(y) for y in x] for x in obj_to_hoi] # return relative act_idxes for each obj_idx
