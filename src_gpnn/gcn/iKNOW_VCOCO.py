...
class Triple_GCN():
    def __init__(self, is_training):
        ...
        self.H_boxes     = tf.placeholder(tf.float32, shape=[None, 1610], name = 'H_boxes')
        self.O_boxes     = tf.placeholder(tf.float32, shape=[None, 1610], name = 'O_boxes')
        self.human_feat = tf.placeholder(tf.float32, shape=[None,1610], name = 'human_feat')
        self.object_feat = tf.placeholder(tf.float32, shape=[None,1610], name = 'object_feat')
        self.H_boxes_enc     = tf.placeholder(tf.float32, shape=[None, 1610], name = 'H_boxes_enc')
        self.O_boxes_enc     = tf.placeholder(tf.float32, shape=[None, 1610], name = 'O_boxes_enc')
