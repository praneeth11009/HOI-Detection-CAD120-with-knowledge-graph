...
pkl.dump(even_more_complete_GT, open( './CAD120_GT_all_subjects_testing_new_wo_having_meal.pkl', "wb"), protocol=pkl.HIGHEST_PROTOCOL)
print("Dumping into  ./CAD120_GT_all_subjects_testing_new_wo_having_meal.pkl")
