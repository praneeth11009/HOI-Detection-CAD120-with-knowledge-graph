# ----------------------------
# Modified based on Tensorflow iCAN
# ----------------------------
...
__C.TRAIN.LEARNING_RATE = 0.01 # 0.001

#__C.TRAIN.BATCH_SIZE = 32 

__C.TRAIN.EPOCHS = 1750 # *8k iters
# __C.TRAIN.EPOCHS = 35 # *8k iters
# __C.TRAIN.EPOCHS = 50 # *8k iters
...
# Iterations between snapshots, save the best
__C.TRAIN.SNAPSHOT_ITERS = 4000


# GCN hidden layer number
__C.HIDDEN = 512
